...
RSpec.describe Seasons::PublicLeaderboardQuery do
  describe ".call" do
    it "returns ranked leaderboards using competition ranking" do
      ...
      previous_match_day = create(:match_day, season:, played_on: match_day.played_on - 1.day)
      ...
      create(:player_rating_change, player: first_player, season:, match_day: previous_match_day, elo_delta: 50, created_at: Time.current)
      ...
      expect(result.ranked_elo.first.entry.last_elo_delta_value).to eq(30)
