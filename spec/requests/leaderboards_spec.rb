  ...
  describe "GET /leaderboards" do
    context "when season ranking data exists" do
      it "renders the public leaderboards page without private phone data" do
        ...
        tooltip_header = document.at_css(".leaderboards-table--record th:last-child .leaderboards-table__header-with-tooltip")
        tooltip_button = document.at_css(".leaderboards-table__tooltip-control")
        tooltip = document.at_css(".leaderboards-table__tooltip")
        expect(tooltip_header.element_children.first["class"]).to include("leaderboards-sort-link")
        expect(tooltip_header.element_children.last["class"]).to include("leaderboards-table__tooltip-anchor")
