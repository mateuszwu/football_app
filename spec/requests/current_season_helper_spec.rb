    ...
    context "when there is an active season" do
      it "returns the current active season name" do
        begin
          ...
          create(:season, name: "Spring 2026", active: false, status: Season::STATUS_ARCHIVED)
          create(:season, name: "Summer 2026", active: true, status: Season::STATUS_ACTIVE, starts_on: Date.new(2026, 6, 1))
