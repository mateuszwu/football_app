  ...
  describe "GET /relationships" do
    context "when public relationship data exists" do
      it "renders the public relationship graph page with a visual network and without private phone data" do
        ...
        expect(mobile_row.at_css(".relationship-mobile-ranking__matches").text.squish).to include("5 100%")
        expect(mobile_row.at_css(".relationship-mobile-ranking__offense").text.squish).to include("10 (5g + 5a)")
        expect(mobile_row.at_css(".relationship-mobile-ranking__mutual").text.squish).to include("5")
      ...
      it "renders the Cytoscape graph tab with controls and without private phone data" do
        ...
        expect(response.body).to include("Pokaż listę zawodników i połączeń")
        expect(response.body).to include("Adam Nowak</a>")
